...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "چیپس ذرت ترددیلا با طعم‌های متنوع و کیفیت عالی، حالا در دیجیکالا قابل خریداری است...",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "خبر خوب برای علاقه‌مندان به سینما! ناچو ترددیلا به زودی در سینماهای سراسر کشور عرضه می‌شود...",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "تاکو یکی از معروف‌ترین غذاهای مکزیکی است که با ترددیلا می‌توانید آن را در خانه تهیه کنید...",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "نان ترتیلا یکی از اصلی‌ترین اجزای غذاهای مکزیکی است. در این مقاله طرز تهیه آن را یاد می‌گیرید...",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "سالسا همراه همیشگی ترددیلا! با ۴ طعم متفاوت سالسا آشنا شوید...",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "انتخاب میان وعده مناسب برای کودکان اهمیت زیادی دارد. ترددیلا یک انتخاب سالم و خوشمزه است...",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "نان ترتیلا یک نان سنتی مکزیکی است که در غذاهای مختلفی استفاده می‌شود...",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "دیپ پنیر تند، یک همراه عالی برای چیپس ترددیلا...",
    content: `
