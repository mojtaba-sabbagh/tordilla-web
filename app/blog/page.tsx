...
export default async function BlogPage({ searchParams }: BlogPageProps) {
  ...
  return (
    <main className="blog-page" dir={locale === "fa" ? "rtl" : "ltr"}>
      <style>{`
        /* same CSS as before – keep exactly as in your original file */
        .blog-page { background: #fdf8f3; min-height: 100vh; }
      ...
      <section className="blog-hero">
        ...
        <div className="blog-hero-logo-ring">
          <Image src="/home/logo.png" alt="Tordilla logo" width={108} height={108} />
        </div>
      </section>
