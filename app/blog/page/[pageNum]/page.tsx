...
export default async function PaginatedBlogPage({ params }: PaginatedPageProps) {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[#fbf5ec] to-white py-12 md:py-16 lg:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-[#8f1d1d]">
              وبلاگ ترددیلا
            </h1>
            <p className="mt-4 text-base md:text-lg lg:text-xl text-neutral-600 max-w-2xl mx-auto">
      ...
      <div className="container mx-auto px-4 md:px-6 py-4">
        <div className="text-sm text-neutral-500">
          ...
          &gt; <span className="text-[#8f1d1d]">صفحه {currentPage}</span>
        </div>
      </div>
