...
export default async function AgencyPage({ searchParams }: AgencyPageProps) {
  const { lang } = await searchParams;
  const locale = getLocaleFromSearchParams(new URLSearchParams({ lang: lang || "fa" }));
  const t = translations[locale].agency;
  const commonT = translations[locale].common; // for breadcrumb home link
  const localeQuery = `?lang=${locale}`;

  return (
    <main className="agency-page" dir={locale === "fa" ? "rtl" : "ltr"}>
       <style>{`
        .agency-page {
          background: #fdf8f3;
          min-height: 100vh;
      ...
      <section className="agency-hero">
        <div className="agency-hero-badge">{t.heroBadge}</div>
        <h1>{t.heroTitle}</h1>
        <p>{t.heroText}</p>
      ...
      <div className="agency-container">
        ...
        <div className="section-card">
          ...
          <div className="benefits-grid">
            <div className="benefit-card">
              ...
              <div className="benefit-title">{t.benefitBrand}</div>
              <div className="benefit-desc">{t.benefitBrandDesc}</div>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon"><TrendingUp /></div>
              <div className="benefit-title">{t.benefitGrowth}</div>
              <div className="benefit-desc">{t.benefitGrowthDesc}</div>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon"><Headset /></div>
              <div className="benefit-title">{t.benefitSupport}</div>
              <div className="benefit-desc">{t.benefitSupportDesc}</div>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon"><Users /></div>
              <div className="benefit-title">{t.benefitStable}</div>
              <div className="benefit-desc">{t.benefitStableDesc}</div>
            </div>
          </div>
        </div>
        ...
        <div className="social-section">
          ...
          <div className="social-icons">
            {/* same SVG icons – keep them as before */}
