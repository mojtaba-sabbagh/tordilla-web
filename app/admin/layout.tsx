...
export default function AdminDashboard() {
  ...
  const [unseenMessagesCount, setUnseenMessagesCount] = useState(0); // Add this
  ...
  const loadData = async () => {
    try {
      await Promise.all([
        ...
        fetchUnseenMessagesCount() // Add this
      ]);
    } catch (error) {
  ...
  // Add this function to fetch unseen messages count
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Stats Cards - Optional: Add message statistics */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Blog Posts Table - Your existing code */}
